...
protocol InstanceServiceDelegate {
...
class InstanceService : NSObject {
    ...
    var delegate : InstanceServiceDelegate?
    ...
    func send(command : String) {
        NSLog("%@", "send: \(command) to \(session.connectedPeers.count) peers")
...
extension InstanceService : MCSessionDelegate {
    ...
    func session(_ session: MCSession, didReceive data: Data, fromPeer peerID: MCPeerID) {
        ...
        self.delegate?.profileChanged(manager: self, profileName: str)
    }
